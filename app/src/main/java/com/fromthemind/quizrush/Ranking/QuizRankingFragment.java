 ...
 * {@link QuizRankingFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link QuizRankingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class QuizRankingFragment extends Fragment {
    ...
    private RushRecyclerViewAdapter.OnListFragmentInteractionListener<DummyItem> mListener;
     ...
     * @return A new instance of fragment QuizRankingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static QuizRankingFragment newInstance(String param1, String param2) {
    ...
    public void listUsers(ArrayList<User> users){
        RecyclerView recyclerView = (RecyclerView) layout.findViewById(R.id.quiz_ranking_list);
        // Set the adapter
        if (recyclerView instanceof RecyclerView) {
            ...
            for (User s: users) {
                count++;
                RushListItem r = new DummyItem(""+count+","+s.getUsername()+","+s.getHighestQuiz());
                list.add(r);
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layout= inflater.inflate(R.layout.fragment_quiz_ranking, container, false);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference userRef = database.getReference("user");
        Query queryRef = userRef.orderByChild("highestQuiz");
